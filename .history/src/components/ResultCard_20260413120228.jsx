              ...
              return (
                <div key={key} className="flex flex-col border-b border-[var(--color-primary)] border-opacity-20 pb-2 last:border-0 last:pb-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className={`text-[10px] font-bold ${level === 'H' ? 'text-green-400 border border-green-400' : level === 'L' ? 'text-red-400 border border-red-400' : 'text-yellow-400 border border-yellow-400'}`} style={{ letterSpacing: 0, padding: '0 1px' }}>
                      {level}
                    </span>
